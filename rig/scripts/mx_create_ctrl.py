...
class MX_CreateCtrl:
    ...
    def create_ctrl(self, type, *args):
        ...
        elif type == 11: # Diamond
            mel.eval("$ctrl = `curve -d 1 -p 0 1.414214 0 -p -1 0 1 -p 1 0 1 -p 0 1.414214 0 -p 1 0 -1 -p -1 0 -1 -p 0 1.414214 0 -p -1 0 1 -p -1 0 -1 -p 1 0 -1 -p 1 0 1 -p -1 0 1 -p 0 -1.414214 0 -p 1 0 1 -p 1 0 -1 -p 0 -1.414214 0 -p -1 0 -1 -p -1 0 1 -p 0 -1.414214 0 -k 0 -k 1 -k 2 -k 3 -k 4 -k 5 -k 6 -k 7 -k 8 -k 9 -k 10 -k 11 -k 12 -k 13 -k 14 -k 15 -k 16 -k 17 -k 18`; rename $ctrl \"ctrl\";")
        elif type == 12: # Locator
             mel.eval("$ctrl = `curve -d 1 -p 0 0 2 -p 0 0 0 -p 0 0 -2 -p 0 0 0 -p 2 0 0 -p 0 0 0 -p -2 0 0 -p 0 0 0 -p 0 2 0 -p 0 -2 0 -k 0 -k 1 -k 2 -k 3 -k 4 -k 5 -k 6 -k 7 -k 8 -k 9`; rename $ctrl \"ctrl\";")
